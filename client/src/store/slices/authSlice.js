...
export const register = (data) => async (dispatch) => {
  ...
  try {
    const res = await axios.post(
      `${import.meta.env.VITE_BACKEND_URL || "http://localhost:5000"}/api/v1/auth/register`,
      data,
      {
...
export const otpVerification = (email, otp) => async (dispatch) => {
  ...
  try {
    const res = await axios.post(
      `${import.meta.env.VITE_BACKEND_URL || "http://localhost:5000"}/api/v1/auth/verify-otp`,
      { email, otp },
      {
        withCredentials: true,
        headers: { "Content-Type": "application/json" },
...
export const login = (data) => async (dispatch) => {
  ...
  try {
    const res = await axios.post(
      `${import.meta.env.VITE_BACKEND_URL || "http://localhost:5000"}/api/v1/auth/login`,
      data,
      {
        withCredentials: true,
        headers: { "Content-Type": "application/json" },
...
export const adminLogin = (data) => async (dispatch) => {
  ...
  try {
    const res = await axios.post(
      `${import.meta.env.VITE_BACKEND_URL || "http://localhost:5000"}/api/v1/auth/admin-login`,
      data,
      {
        withCredentials: true,
        headers: { "Content-Type": "application/json" },
...
export const googleLogin = (data) => async (dispatch) => {
  ...
  try {
    const res = await axios.post(
      `${import.meta.env.VITE_BACKEND_URL || "http://localhost:5000"}/api/v1/auth/social-login`,
      data,
      {
        withCredentials: true,
        headers: { "Content-Type": "application/json" },
...
export const logout = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL || "http://localhost:5000"}/api/v1/auth/logout`, {
      withCredentials: true,
    });
...
export const getUser = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL || "http://localhost:5000"}/api/v1/auth/me`, {
      withCredentials: true,
    });
...
export const forgotPassword = (email) => async (dispatch) => {
  ...
  try {
    const res = await axios.post(
      `${import.meta.env.VITE_BACKEND_URL || "http://localhost:5000"}/api/v1/auth/password/forgot`,
      { email },
      {
        withCredentials: true,
        headers: { "Content-Type": "application/json" },
...
export const verifyForgotPasswordOtp = (email, otp) => async (dispatch) => {
  ...
  try {
    const res = await axios.post(
      `${import.meta.env.VITE_BACKEND_URL || "http://localhost:5000"}/api/v1/auth/password/verify-otp`,
      { email, otp },
      {
        withCredentials: true,
        headers: { "Content-Type": "application/json" },
...
export const resetPassword = (data, token) => async (dispatch) => {
  ...
  try {
    const res = await axios.put(
      `${import.meta.env.VITE_BACKEND_URL || "http://localhost:5000"}/api/v1/auth/password/reset/${token}`,
      data,
      {
        withCredentials: true,
        headers: { "Content-Type": "application/json" },
...
export const updatePassword = (data) => async (dispatch) => {
  ...
  try {
    const res = await axios.put(
      `${import.meta.env.VITE_BACKEND_URL || "http://localhost:5000"}/api/v1/auth/password/update`,
      data,
      {
        withCredentials: true,
        headers: { "Content-Type": "application/json" },
...
export const updateCredentials = (data) => async (dispatch) => {
  ...
  try {
    const res = await axios.put(
      `${import.meta.env.VITE_BACKEND_URL || "http://localhost:5000"}/api/v1/auth/profile/update`,
      data,
      {
        withCredentials: true,
      }
...
export const uploadAvatarAction = (formData) => async (dispatch) => {
  dispatch(authSlice.actions.updateProfileRequest());
  try {
    const { data } = await axios.post(`${import.meta.env.VITE_BACKEND_URL || "http://localhost:5000"}/api/v1/auth/avatar`, formData, {
      withCredentials: true,
