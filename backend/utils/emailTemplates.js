export function generateVerificationOtpEmailTemplate(otpCode) {
  return `
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; background-color: #f9f9f9;">
    <h2 style="color: #fff; text-align: center; background: #000; padding: 10px;">Verify Your Email Address</h2>
    <p style="font-size: 16px; color: #383535ff;">Dear User,</p>
    <p style="font-size: 16px; color: #383535ff;">To complete your registration or login, please use the following verification code:</p>
    <div style="text-align: center; margin: 20px 0;">
      <span style="display: inline-block; font-size: 24px; font-weight: bold; color: #000; padding: 10px 20px; border: 1px dashed #000;">
        ${otpCode}
      </span>
    </div>
    <p style="font-size: 16px; color: #383535ff;">This code is valid for 15 minutes. Please do not share this code with anyone.</p>
    <p style="font-size: 16px; color: #383535ff;">If you did not request this email, please ignore it.</p>
